...
const page = () => {
    ...
    const events = [
        { value: 'All Candidate', label: 'All Candidate' },
    ...
    return (
        <div className='Wrapper'>
            ...
            <div className='searchWrapper'>
                ...
                {((stuData && stuData.length > 0) || event === 'All Candidate') && (
                    <div className='tableWrapper'>
                        <h1>{event === 'All Candidate' ? 'All Candidates' : `${event} List.`}</h1>
                        <TableContainer component={Paper}>
                            <Table sx={{ m: 'auto', minWidth: 700, maxWidth: 1100 }} aria-label="customized table">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <StyledTableCell align="left"><b>Event</b></StyledTableCell>
                                        <StyledTableCell align="left"><b>College</b></StyledTableCell>
                                        <StyledTableCell align="left"><b>Contact</b></StyledTableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {event === 'All Candidate'
                                        ? stuData.map((student, index) => (
                                            <StyledTableRow key={student.id}>
                                                ...
                                                <StyledTableCell align="left">
                                                    <b>{student.College_Name}</b>
                                                </StyledTableCell>
                                                <StyledTableCell align="left">
                                                    <b>{student.Contact_Number}</b>
                                                </StyledTableCell>
                                            </StyledTableRow>
                                        ))
